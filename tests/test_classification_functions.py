...
from money_mate.classification import classify_by_type, refine_by_name, prep_account_statement, calculate_smoking_adjustment, apply_smoking_adjustment
...
def test_calculate_smoking_adjustment():
    ...
    expected_adjustment_amount = -26  # Sum of -12 and -14 (within -11 and -15 range)
